...
namespace NGribCS.Grib1
{
	...
	public sealed class Grib1Input : NGribCS.Grib1.IGrib1Input
	{
		...
		/// <returns> products 
		/// </returns>
		public List<Grib1Product> Products
		{
			get
			{
				return products;
		...
		/// <returns> gdsHM 
		/// </returns>
		public Dictionary<string, Grib1GridDefinitionSection> GDSs
		{
			get
			{
				return gdsHM;
		...
		*/
        ...
        private List<Grib1Product> products = new List<Grib1Product>();
		...
		*/
        ...
        private Dictionary<string, Grib1GridDefinitionSection> gdsHM = new Dictionary<string, Grib1GridDefinitionSection>();
